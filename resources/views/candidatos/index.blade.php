                        ...
                        <ul class="divide-y divide-gray-200 w-full">
                            ...
                            @forelse ($candidatos as $candidato)
                                <li class="p-3 flex items-center">
                                    ...
                                    <div>
                                        <a
                                            class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-gray-300 text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-gray-300"
